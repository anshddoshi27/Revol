...
Revol is a modular, offline-first, white-label booking PWA built with React + Tailwind, Flask, and Supabase/Postgres (RLS enforced). Features include Google Calendar sync, Stripe Connect payments, real-time updates, no-overlap booking, analytics, promotions, notifications, and a 3% new-customer royalty model.
